...
const findCountriesbyId = (id, countries) => {
    const countryFilter = countries.find(country => country.id.toLowerCase() === id.toLowerCase());
    if(!countryFilter) throw new Error("No se encontró ningún país con el id ingresado");
